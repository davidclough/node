...
namespace Abc.Container
{
    public class AutoFacConfiguration
    {
        ...
        // Used for standard API requests.
        public static ContainerBuilder WebApiBuilder
        {
            get
            {
                ...
                {
                    var requiredLifetimeScope = LifetimeScopeType.PerRequest;
        ...
        // Occasionally used by longer running tasks which may last beyond the lifetime of a request, e.g.
        // if created another thread on which to generate data and call an end point in another API when that has completed.
